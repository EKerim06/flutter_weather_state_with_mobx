...
//
//     final anlikHavaDurumu = anlikHavaDurumuFromJson(jsonString);

import 'dart:convert';

class AnlikHavaDurumu {
  AnlikHavaDurumu({
    required this.coord,
  ...
  factory AnlikHavaDurumu.fromRawJson(String str) =>
      AnlikHavaDurumu.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory AnlikHavaDurumu.fromJson(Map<String, dynamic> json) =>
      AnlikHavaDurumu(
